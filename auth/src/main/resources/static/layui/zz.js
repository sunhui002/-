...
$(".section_dnsm_zuo,.section_w3c_zuo,.section_ayd_zuo,.section_ac_zuo").hover(function() {
    $(this).children('img').attr('src', './layui/img/left-active.png');
}, function() {
    $(this).children('img').attr('src', './layui/img/left.png');
});
$(".section_dnsm_you,.section_w3c_you,.section_ayd_you,.section_ac_you").hover(function() {
    $(this).children('img').attr('src', './layui/img/right-active.png');
}, function() {
    $(this).children('img').attr('src', './layui/img/right.png');
});
